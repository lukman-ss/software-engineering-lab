...
> **Catatan:** Optimistic locking adalah salah satu strategi concurrency control. Lab ini tidak mengimplementasikannya secara penuh — lihat [`labs/93-optimistic-locking`](https://github.com/lukman-ss/software-engineering-lab/tree/main/labs/93-optimistic-locking) untuk production-ready implementation.
